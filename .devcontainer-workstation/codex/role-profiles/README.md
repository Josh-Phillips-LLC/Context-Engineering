...
- Runtime role instructions are generated at `/workspace/instructions/role-instructions.md` from workspace sources first, then image-baked compiled role instructions, then image-baked fallback sources.
